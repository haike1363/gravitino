...
/** Generates COS token to access COS data. */
public class COSTokenProvider implements CredentialProvider {
  ...
  public void initialize(Map<String, String> properties) {
    COSCredentialConfig credentialConfig = new COSCredentialConfig(properties);
    this.roleArn = credentialConfig.cosRoleArn();
  ...
  public Credential getCredential(CredentialContext context) {
    ...
    return new COSTokenCredential(accessKeyId, secretAccessKey, "", 0);
    // TODO
    //    CredentialModel credentialModel =
    //      createCOSCredentialModel(
    //        roleArn,
